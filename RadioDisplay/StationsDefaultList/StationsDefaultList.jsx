   ...
   return (
      ...
      <div className='default-stations-lists__wraper'>
         ...
         <div className="default-stations__wraper-up">
            <Station dot={"down"} min={2} max={5} contryName={"France"} />
            ...
            <Station dot={"down"} min={37} max={40} contryName={"Andorra"} />
         </div>
         ...
         <div className="default-stations__wraper-down">
            ...
            <Station dot={"up"} min={32} max={36} contryName={"Czechia"} />
            <Station dot={"up"} min={41} max={45} contryName={"Panama"} />
         </div>

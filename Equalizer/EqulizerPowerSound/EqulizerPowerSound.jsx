...
function EqulizerPowerSound({ playPauseSwitch }) {
  ...
  let switchProgresBar = useSelector(
    (state) => state.visualLoad.switchProgresBar
  );
  ...
  useEffect(() => {
    ...
    if (playPauseSwitch === true) {
      averageVolume >= 150
        ? setColor10("var(--color-power-sound100)")
        : setColor10("");
      averageVolume >= 140
        ? setColor9("var( --color-power-sound100)")
        : setColor9("");
      averageVolume >= 130
        ? setColor8("var(--color-power-sound70)")
        : setColor8("");
      averageVolume >= 120
        ? setColor7("var( --color-power-sound70)")
        : setColor7("");
      averageVolume >= 110
        ? setColor6("var( --color-power-sound60)")
        : setColor6("");
      averageVolume >= 100
        ? setColor5("var(--color-power-sound60)")
        : setColor5("");
      averageVolume >= 80
        ? setColor4("var( --color-power-sound50)")
        : setColor4("");
      averageVolume >= 60
        ? setColor3("var( --color-power-sound50)")
        : setColor3("");
      averageVolume >= 20
        ? setColor2("var( --color-power-sound20)")
        : setColor2("");
      averageVolume >= 10
        ? setColor1("var( --color-power-sound20)")
        : setColor1("");
    }
  ...
  return (
    <div ref={elements} className="equalizer-visual__average-volume-wraper">
      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem10}` }}
      ></div>
      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem9}` }}
      ></div>

      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem8}` }}
      ></div>
      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem7}` }}
      ></div>

      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem6}` }}
      ></div>
      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem5}` }}
      ></div>

      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem4}` }}
      ></div>
      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem3}` }}
      ></div>

      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem2}` }}
      ></div>
      <div
        className="equalizer-visual__average-volume-element"
        style={{ background: `${colorElem1}` }}
      ></div>
    </div>
  );
}

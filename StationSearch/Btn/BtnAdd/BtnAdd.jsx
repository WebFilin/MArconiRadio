...
function BtnAdd({ idStations, isActive, localStorageTriger }) {
   ...
   React.useEffect(() => {
      ...
      const btnActive = <div className="search-stations__btn-add-body-active"></div>

      const btnDefault = <div className="search-stations__items-btn-add-body-elem"></div>

      const btnBodyDisabled = <div className="search-stations__items-btn-add-body-disabled"></div>
   ...
   return (
      <div className={isWraperBtn} >
         <button disabled={isDisabledBtn} className="search-stations__items-btn-add-body" onClick={handlerClick}>
            {isActiveClicAnimo}
         </button>
      </div>
   );
